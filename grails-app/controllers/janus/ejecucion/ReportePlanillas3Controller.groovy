...
//                }
        ...
        addCellTabla(tablaB0, new Paragraph("Periodo utilizado", fontTh), [border: Color.BLACK, bg: Color.LIGHT_GRAY, align: Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE, colspan: 2])
        periodos.each { per ->
...
//                println "\t\t" + retrasoLiq2
        ...
        addCellTabla(tablaMultaUsu, new Paragraph(numero(planilla.descripcionMulta, 0), fontTd), [border: Color.BLACK, align: Element.ALIGN_LEFT, valign: Element.ALIGN_MIDDLE])
