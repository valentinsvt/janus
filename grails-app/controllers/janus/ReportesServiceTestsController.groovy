...
class ReportesServiceTestsController {
    ...
    def reporteTest() {
        ...
        reportesPdfService.documentoHeader(document, "G.A.D. Pichincha", true)
        ...
        preface.add(new Paragraph("G.A.D. PROVINCIA DE PICHINCHA", reportesPdfService.fontTituloGad));
