...
<div> <!-- Manejo de perfiles y permisos pg 12, 13, 14, 15-->
    ...
    <br><p><strong>Eliminar del M&oacutedulo: </strong>Rompe la asociaci&oacuten de
...
<br><p>Los comandos disponibles en esta pantalla son los siguientes:</p>
</div>
<div class="centrado">
...
<div class="centrado">
    <br><h2 class="izquierda" class="cursiva">Registro de Obras</h2>
...
<div class="centrado">
    <br><h3 class="izquierda">Lista</h3>
...
<div class="centrado">
    ...
    <br><h3 class="izquierda">Grabar</h3>
    ...
    <br><br><h3 class="izquierda">Cancelar</h3>
    <p>Deshace cualquier cambio realizado en la pantalla de registro de obra.</p>
    <!-- Empieza rob  -->
    <a id="Imprimir"></a><br>
    <br><h3 class="izquierda">Eliminar la Obra</h3>
...
<div class="centrado">
    ...
    <table>
        <tr>
            ...
            <td> <img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'imagen364.png')}"></img></td>
        </tr>
    </table>
    <br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'imagen365.png')}"><br><br>
    ...
    <br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'imagen366.png')}"><br><br>
    ...
    <br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'imagen369.png')}"><br><br>
</div>
...
<div class="centrado">
    ...
    <br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'imagen375.png')}"><br><br>
    <p>Al presionar el bot&oacuten &#34Calcular&#34 se presentan los valores.</p>

    <br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'imagen376.png')}"><br><br>
...
<div><!--50, 51, 52, 53, 54-->
    ...
    <br><br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'img202.png')}"/><br><br>
    ...
    <p>Adem&aacutes el sistema nos preguntar&aacute si deseamos imprimir el
    reporte incluyendo un desglose en los valores de transporte o caso contrario
    ...
    <br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'img206.png')}"/><br><br><br> <!--52-->
    ...
    <br><p>Si se desea copiar solo los rubros seleccionados, marcamos los mismos
...
seleccionado&quot.
    ...
    <br><br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'img210.png')}"/><!--54--> <br> <br> <br>
</div>
...
<div> <!--Matriz de Formula Polinomica pg 54, 55, 56-->
    ...
    <br><p>El bot&oacuten Matriz FP, nos lleva a ejecutar un proceso de c&aacutelculo
...
<div> <!-- Formula polinomica pg 57, 58-->
    <br><br><h2>F&oacutermula polin&oacutemica</h2>
...
<div> <!-- Trabajando en la composicion de la formula polinomica pg 58,59-->
    <br><br><h2>Trabajando en la composici&oacuten de la f&oacutermula polin&oacutemica
</h2>
    <p><br>
...
<div><!--Cronograma pg 61, 62, 63, 64-->
    ...
    <br><p>Al hacer clic en una fila, se marcan en azul las 3 filas correspondientes
...
<div><!-- Composicion de la Obra pg 65, 66-->
    <br><br><h2>Composici&oacuten de la Obra</h2>
    <br><p>Los &iacutetems que componen la obra se muestra al hacer un clic en
...
<div> <!-- Documentos de la Obra pg 66,-->
    ...
    <p><br><strong>PRESUPUESTO</strong><p/>
    ...
    <br><br><p><strong>Tipo de Reporte</strong></p>
    <br><p>En esta secci&oacuten debemos obligatoriamente seleccionar una de
los dos tipos de reporte que se presentan.
    ...
    <br><p>Permite seleccionar el pie de p&aacutegina ha ser agregado en
...
pagina ya existente.
    ...
    <br><p>Son el conjunto de firmas que se colocaran al final del documento.</p>
    <!--69-->
    ...
    <br><br><p><strong>Reajuste del Presupuesto</strong></p>
    <br><p>Una vez se da clic sobre el bot&oacuten imprimir se nos
...
las cuales incluyen agregar el IVA y el reajuste del presupuesto.
    ...
    </div><p><br><strong>MEMORANDO</strong></p>  <!--70-->
    ...
    <br><p>Muestra un conjunto de datos de la obra registrada; en la parte inferior
...
bot&oacuten para calcular dicho valor.
    ...
    <br><p>Nos presenta los textos a ser colocados en el documento impreso.</p>
    ...
    <br><p>Son el conjunto de firmas que se colocar&aacuten al final del documento.</p>
    ...
    <br><p><strong>Datos</strong></p>
    <br><p>Presenta un conjunto de datos provenientes del registro de la Obra.</p>
    <div class="centrado">
        <br><img src="${resource(dir:'images/imagenesManuales/imagenesIngreso', file:'img253.png')}"/>
    </div>
    <p><br><strong>Nota</strong></p>
    <br><p>Este texto se colocar&aacute luego de la tabla con los coeficientes
de los componentes.
</p>
    <div class="centrado">
    ...
    <br><p>Muestra un conjunto de textos que se colocar&aacuten en los diferentes
