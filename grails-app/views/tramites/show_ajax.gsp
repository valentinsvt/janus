...
<div id="show-tramite" class="span5" role="main">
    ...
    <form class="form-horizontal">
        ...
        <g:if test="${tramiteInstance?.memo}">
            <div class="control-group">
                <div>
                ...
                <div class="controls">
                    ...
                    <span aria-labelledby="memo-label">
                        <g:link controller="tramite" action="verTramites" id="${tramiteInstance.memo}" title="Ver trámite en el S.A.D.">
                            <g:fieldValue bean="${tramiteInstance}" field="memo"/>
                        </g:link>
                    </span>
