...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="span3" id="busqueda-Indice"></div>
        </div>

        <g:form action="delete" name="frmDelete-Indice">
            ...
            <table class="table table-bordered table-striped table-condensed table-hover">
                ...
                <g:each in="${indiceInstanceList}" status="i" var="indiceInstance">
                    <tr>
                        ...
                        <td>${fieldValue(bean: indiceInstance, field: "tipoIndice")}</td>
