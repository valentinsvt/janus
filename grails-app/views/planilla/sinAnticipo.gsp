...
<body>
%{--<g:if test="${tipos.find { it.codigo == 'A' } || periodosOk.size() > 0}">  inicial --}%
...
<g:if test="${planillaInstance?.id || (tipos.find {
    it.codigo == 'E'
} && planillaInstance?.fechaMemoSalidaPlanilla == null)}">
%{--<g:if test="${!liquidado}">--}%
    <g:form name="frmSave-Planilla" action="saveSinAntc">
        <fieldset>
...
--}%
            ...
            <div class="row" style="margin-bottom: 10px;" id="divMultaDisp">
                <div class='span2 formato'>
            ...
            <div class="row">
                ...
                <div class="row" style="margin-bottom: 10px;" id="divMulta">
                    <div class='span2 formato'>
                        Multa
                    </div>
