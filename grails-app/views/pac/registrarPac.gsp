    ...
    <div class="borde_abajo" style="padding-left: 45px;position: relative;">
        ...
        <div class="row-fluid" style="margin-left: 0px">
            <div class="span1" >
                <b>Año:</b>
                %{--janus.Anio.list()--}%
                <g:select name="anio" from="" id="item_anio" style="width: 80px;font-size: 10px"></g:select>
            </div>
            <div class="span3">
                <b>Departamento:</b>
            ...
            <div class="span3">
                <b>Tipo compra:</b>
                <g:select name="tipo" from="" optionKey="id" optionValue="descripcion" style="width: 250px;;font-size: 10px" id="item_tipo"></g:select>
            </div>
            <div class="span2" >
                <b>Código C.P.:</b>
                <input type="text" style="width: 80px;;font-size: 10px" id="item_codigo">
        ...
        <div class="row-fluid" style="margin-left: 0px">
            ...
            <div class="span1" >
                <b>Unidad:</b>
                <g:select name="unidad.id" from="${janus.Unidad.list()}" id="item_unidad"  optionKey="id" optionValue="codigo" style="width: 70px;font-size: 10px"></g:select>
            </div>
            <div class="span2">
                <b>Cuatrimestre:</b>
            ...
            <div class="span1" style="margin-left: 30px;padding-top:30px">
