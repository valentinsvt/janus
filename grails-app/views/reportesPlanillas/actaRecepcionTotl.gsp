    ...
    <head>
        ...
        @page {
            @bottom-right {
                ...
                content   : 'Elaborado por: ${actaInstance.contrato.administrador.titulo ?: ""} ${actaInstance.contrato.administrador.nombre} ${actaInstance.contrato.administrador.apellido} (ADMINISTRADOR${actaInstance.contrato.administrador.sexo == "F"? "A": "" })';
                font-size : 8pt;
                color     : #000;
            }
        }
