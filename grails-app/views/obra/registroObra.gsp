                ...
                <div class="navbar-inner">
                    <div class="botones">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="${g.createLink(controller: 'matriz', action: 'matrizPolinomica', id: obra?.id)}"><i class="icon-th"></i>Matriz FP
                            </a></li>
                            <li><a href="#">Fórmula Pol.</a></li>
                            <li><a href="#">FP Liquidación</a></li>
                            <li><a href="#" id="btnRubros"><i class="icon-money"></i>Rubros</a></li>
                            <li><a href="${g.createLink(controller: 'documentosObra', action: 'documentosObra', id: obra?.id)}" id="btnDocumentos"><i class="icon-file"></i>Documentos
                            </a></li>
