...
<fieldset class="borde">
    ...
    <div class="span12">
        ...
        <div class="span2"><button class="btn btn-buscar" id="btn-buscar"><i class="icon-globe"></i> Buscar</button>
        </div>
...
<div id="busqueda">
    ...
    <fieldset class="borde">
        ...
        <div>
            ...
            <div class="span2" style="margin-left: 140px"> <button class="btn btn-info" id="btn-consultar"><i class="icon-check"></i> Consultar</button></div>
...
<div class="navbar navbar-inverse" style="margin-top: 10px;padding-left: 5px" align="center">
    ...
    <div class="navbar-inner">
        <div class="botones">
            ...
            <ul class="nav">
                <li class="active">
                    <a href="#"><i class="icon-pencil"></i>Variables</a>
                </li>
