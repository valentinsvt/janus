...
<div style="border-bottom: 1px solid black;padding-left: 50px;position: relative;height: 150px;margin-bottom: 10px;">
    <p class="css-vertical-text" style="font-size: 30px;margin-left: -7px"><i class="icon-arrow-left active" id="min" style="cursor: pointer" title="Ocultar"></i> <span id="msg" title="Ocultar" style="cursor: pointer"> P.A.C.</span></p>
...
<div style="border-bottom: 1px solid black;padding-left: 50px;position: relative;height: 580px;margin-bottom: 10px;">
