...
<div class="span8 btn-group" data-toggle="buttons-radio">
    ...
    <form class="form-search" style="width: 400px; margin-left: 380px; margin-top: -30px;">
        ...
        <input type="button" class="btn " value="Cerrar todo" onclick="$('#tree').jstree('close_all');" style="margin-left: 5px">
    </form>
...
<div class="span2">
    <a href="#" id="btnItemsUso" class="btn btn-primary">
        <i class="icon-list"></i>
        Item en uso
    </a>
</div>
...
<script type="text/javascript">
    ...
    $("#btnItemsUso").click(function () {
        location.href = "${createLink(controller: 'mantenimientoItems', action: 'itemsUso')}"
    });
